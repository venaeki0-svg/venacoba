...
export const SettingsIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 0 2l-.15.08a2 2 0 0 1-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.38a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1 0 2l.15.08a2 2 0 0 0 .73-2.73l.22-.38a2 2 0 0 0-2.73-.73l-.15-.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>
);
...
// Export empty arrays for all data entities as they will be fetched from Supabase
...
// Default profile will be loaded from Supabase
export const MOCK_USER_PROFILE: Profile | null = null
...
// Keep enum values and static configurations - adjusted to match Supabase data structure where applicable
export const CLIENT_STATUS_OPTIONS = ['Active', 'Inactive', 'Pending'] as const
export const CLIENT_TYPE_OPTIONS = ['Direct', 'Vendor', 'Referral'] as const
export const PAYMENT_STATUS_OPTIONS = ['Unpaid', 'DP', 'Paid'] as const
export const LEAD_STATUS_OPTIONS = ['New', 'Follow Up', 'Converted', 'Rejected'] as const
export const CONTACT_CHANNEL_OPTIONS = ['Instagram', 'WhatsApp', 'Website', 'Referral', 'Other'] as const
export const TRANSACTION_TYPE_OPTIONS = ['Income', 'Expense'] as const
export const PAYMENT_METHOD_OPTIONS = ['Cash', 'Bank Transfer', 'E-wallet', 'Credit Card'] as const
export const ASSET_STATUS_OPTIONS = ['Available', 'In Use', 'Maintenance', 'Sold', 'Lost'] as const
export const SATISFACTION_OPTIONS = ['Very Satisfied', 'Satisfied', 'Neutral', 'Unsatisfied'] as const
export const CARD_TYPE_OPTIONS = ['Debit', 'Credit'] as const
export const POCKET_TYPE_OPTIONS = ['Saving', 'Investment', 'Emergency Fund', 'Locked', 'Reward Pool'] as const
export const POCKET_ICON_OPTIONS = ['piggy-bank', 'lock', 'clipboard-list', 'star', 'target', 'home', 'car', 'plane', 'graduation-cap', 'briefcase'] as const
export const POST_TYPE_OPTIONS = ['Photo', 'Video', 'Story', 'Reel', 'Blog'] as const
export const PLATFORM_OPTIONS = ['Instagram', 'Facebook', 'TikTok', 'YouTube', 'Website'] as const
export const POST_STATUS_OPTIONS = ['Draft', 'Scheduled', 'Posted'] as const
export const DISCOUNT_TYPE_OPTIONS = ['percentage', 'fixed'] as const
export const NOTIFICATION_ICON_OPTIONS = ['bell', 'user', 'project', 'payment', 'calendar', 'lead', 'completed', 'revision', 'deadline'] as const
export const VIEW_TYPE_OPTIONS = ['DASHBOARD', 'PROSPEK', 'CLIENTS', 'PROJECTS', 'TEAM', 'FINANCE', 'CALENDAR', 'CLIENT_REPORTS', 'PACKAGES', 'PROMO_CODES', 'ASSETS', 'CONTRACTS', 'SOP', 'SOCIAL_MEDIA_PLANNER', 'SETTINGS'] as const
export const PROJECT_STATUS_OPTIONS = ['Pending', 'Preparation', 'Confirmed', 'Editing', 'Revisi', 'Printing', 'Shipped', 'Completed', 'Cancelled'] as const
export const PERFORMANCE_NOTE_TYPE_OPTIONS = ['Praise', 'Late Deadline', 'Mistake'] as const
export const REVISION_STATUS_OPTIONS = ['Pending', 'In Progress', 'Completed', 'Rejected'] as const
export const SOCIAL_MEDIA_PLATFORM_OPTIONS = ['Instagram', 'Facebook', 'TikTok', 'YouTube', 'Website'] as const